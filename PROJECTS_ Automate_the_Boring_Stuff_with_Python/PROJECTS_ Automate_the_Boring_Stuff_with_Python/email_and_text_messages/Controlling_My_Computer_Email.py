# Start task on your computer by information sent by email
...
MY_EMAIL = 'junior.destoper@gmail.com' # bot should only respond to me
BOT_EMAIL = 'destoper.automate@gmail.com'
BOT_EMAIL_PASSWORD = '----------------'
...
def parseInstructionEmail(instruction):
    ...
    # Email the response body to be to confirm the bot carried out this instruction.
